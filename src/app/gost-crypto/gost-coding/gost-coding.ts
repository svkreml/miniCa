...
/*
    public static decode(s: string): ArrayBuffer{
       return JSBase64.decode(s);
    }

    public static encode(s: ArrayBuffer): string{
        return JSBase64.encode(s);
    }
...
*/
      ...
      public static encode(data): string {
          ...
          let toReturn = s.substr(0, s.length - 2 + m3);
          if (m3 === 2) {
              toReturn += '';
          } else if (m3 === 1) {
              toReturn += '=';
