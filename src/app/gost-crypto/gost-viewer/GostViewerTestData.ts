export class GostViewerTestData {
    ...
    public static certGost: string =
        'MIIFHDCCBMmgAwIBAgIQOyCK5f1GaIZJoFD6r6iDkzAKBggqhQMHAQEDAjCCAQox\n' +
        'GDAWBgUqhQNkARINMTIzNDU2Nzg5MDEyMzEaMBgGCCqFAwOBAwEBEgwwMDEyMzQ1\n' +
        'Njc4OTAxLzAtBgNVBAkMJtGD0LsuINCh0YPRidGR0LLRgdC60LjQuSDQstCw0Lsg\n' +
        '0LQuIDE4MQswCQYDVQQGEwJSVTEZMBcGA1UECAwQ0LMuINCc0L7RgdC60LLQsDEV\n' +
        'MBMGA1UEBwwM0JzQvtGB0LrQstCwMSUwIwYDVQQKDBzQntCe0J4gItCa0KDQmNCf\n' +
        '0KLQni3Qn9Cg0J4iMTswOQYDVQQDDDLQotC10YHRgtC+0LLRi9C5INCj0KYg0J7Q\n' +
        'ntCeICLQmtCg0JjQn9Ci0J4t0J/QoNCeIjAeFw0xODA5MTIxMDE5MzBaFw0yMzA5\n' +
        'MTIxMDI4NTVaMIIBCjEYMBYGBSqFA2QBEg0xMjM0NTY3ODkwMTIzMRowGAYIKoUD\n' +
        ...
        'stGL0Lkg0KPQpiDQntCe0J4gItCa0KDQmNCf0KLQni3Qn9Cg0J4iMGYwHwYIKoUD\n' +
        'BwEBAQEwEwYHKoUDAgIjAQYIKoUDBwEBAgIDQwAEQJgf/alQzSGGMPRZBnKp1j1r\n' +
        'wDOCBkY349whSrH4n7dW7KUttYGHtp3CLt/9CTNTnBgyrNdCLgml9DajpcHSIvCj\n' +
        'ggH+MIIB+jA2BgUqhQNkbwQtDCsi0JrRgNC40L/RgtC+0J/RgNC+IENTUCIgKNCy\n' +
        '0LXRgNGB0LjRjyA0LjApMIIBIQYFKoUDZHAEggEWMIIBEgwrItCa0YDQuNC/0YLQ\n' +
        'vtCf0YDQviBDU1AiICjQstC10YDRgdC40Y8gNC4wKQxB0KPQtNC+0YHRgtC+0LLQ\n' +
        'tdGA0Y/RjtGJ0LjQuSDRhtC10L3RgtGAICLQmtGA0LjQv9GC0L7Qn9GA0L4g0KPQ\n' +
        'piIMT9Ch0LXRgNGC0LjRhNC40LrQsNGCINGB0L7QvtGC0LLQtdGC0YHRgtCy0LjR\n' +
        'jyDihJYg0KHQpC8wMDAtMDAwMCDQvtGCIDAwLjAwLjAwMDAMT9Ch0LXRgNGC0LjR\n' +
        'hNC40LrQsNGCINGB0L7QvtGC0LLQtdGC0YHRgtCy0LjRjyDihJYg0KHQpC8wMDAt\n' +
        'MDAwMCDQvtGCIDAwLjAwLjAwMDAwCwYDVR0PBAQDAgGGMA8GA1UdEwEB/wQFMAMB\n' +
        'Af8wHQYDVR0OBBYEFJuFXvuB3E1ZB1Fjz77f2ix/yUQ8MBIGCSsGAQQBgjcVAQQF\n' +
        'AgMBAAEwJQYDVR0gBB4wHDAIBgYqhQNkcQEwCAYGKoUDZHECMAYGBFUdIAAwIwYJ\n' +
        'KwYBBAGCNxUCBBYEFMjaZsu2l9I+yWcdwltkOqvcu89pMAoGCCqFAwcBAQMCA0EA\n' +
        'PpXN2B+VvQmrc4L1BODyZhIygpsrA8xLwLNz+OcN1r2DyCctAcHs72VdrHf93dqd\n' +
        'BOK/6AJ/hzYbz6x6KJwh/g==';
    public static certGoogleECDSAP256: string =
    ...
    public static certGost256: string =
        'MIIIOjCCB+egAwIBAgIQaw9xAB+oXr1Eh2RFC4e+cTAKBggqhQMHAQEDAjCCAVsx\n' +
        ...
        'KNCj0KYgMi4wKTAeFw0xNzExMDIwNjQxNDFaFw0xOTAyMDIwNjUxNDFaMIH+MRow\n' +
        'GAYIKoUDA4EDAQESDDAwNzcxNzEwNzk5MTEYMBYGBSqFA2QBEg0xMDM3NzAwMDg1\n' +
        'NDQ0MSUwIwYDVQQKDBzQntCe0J4gItCa0KDQmNCf0KLQni3Qn9Cg0J4iMTAwLgYD\n' +
        'VQQJDCfRg9C7LiDQodGD0YnQtdCy0YHQutC40Lkg0JLQsNC7LCDQtC4gMTgxFTAT\n' +
        'BgNVBAcMDNCc0L7RgdC60LLQsDEYMBYGA1UECAwPNzcg0JzQvtGB0LrQstCwMQsw\n' +
        'CQYDVQQGEwJSVTEvMC0GA1UEAwwm0KLQtdGB0YLQvtCy0YvQuSDQvtC/0LXRgNCw\n' +
        '0YLQvtGAIE9DU1AwZjAfBggqhQMHAQEBATATBgcqhQMCAiMBBggqhQMHAQECAgND\n' +
        'AARA6zmJ8bQgyC853XsleA6n//xE/5k5JMRFrAyUQUvGlxPnOqlrL9V+8iz/Jk3e\n' +
        'W54+9X+GPz8WzJZj3grTn9ernaOCBNgwggTUMA4GA1UdDwEB/wQEAwIGwDAdBgNV\n' +
        'HQ4EFgQUrIAkFShJO+bbF22hRS0gw5GmeQswNQYJKwYBBAGCNxUHBCgwJgYeKoUD\n' +
        'AgIyAQmEvedQgu/+MYW1kyKD/7BCgv1Hg4k3AgEBAgEAMIIBlwYDVR0jBIIBjjCC\n' +
        'AYqAFLt+/EEtSn67Eg8EwgVbTOwy8M9boYIBXqSCAVowggFWMSEwHwYJKoZIhvcN\n' +
        'AQkBFhIgaW5mb0BjcnlwdG9wcm8ucnUxGDAWBgUqhQNkARINMTAzNzcwMDA4NTQ0\n' +
        'NDEaMBgGCCqFAwOBAwEBEgwwMDc3MTcxMDc5OTExCzAJBgNVBAYTAlJVMRgwFgYD\n' +
        ...
        'BgNVBAoMHNCe0J7QniAi0JrQoNCY0J/QotCeLdCf0KDQniIxZTBjBgNVBAMMXNCi\n' +
        '0LXRgdGC0L7QstGL0Lkg0LPQvtC70L7QstC90L7QuSDQo9CmINCe0J7QniAi0JrQ\n' +
        'oNCY0J/QotCeLdCf0KDQniIg0JPQntCh0KIgMjAxMiAo0KPQpiAyLjApghAT4eoA\n' +
        'HqgnqEmoGGorqHBOMBMGA1UdJQQMMAoGCCsGAQUFBwMJMBsGCSsGAQQBgjcVCgQO\n' +
        'MAwwCgYIKwYBBQUHAwkwHQYDVR0gBBYwFDAIBgYqhQNkcQIwCAYGKoUDZHEBMA8G\n' +
        'CSsGAQUFBzABBQQCBQAwggFDBgUqhQNkcASCATgwggE0DDTQodCa0JfQmCAi0JrR\n' +
        'gNC40L/RgtC+0J/RgNC+IENTUCIgKNCy0LXRgNGB0LjRjyA0LjApDFrQn9CQ0Jog\n' +
        ...
        'MzAxMCDQvtGCIDMwLjEyLjIwMTYMT9Ch0LXRgNGC0LjRhNC40LrQsNGCINGB0L7Q\n' +
        'vtGC0LLQtdGC0YHRgtCy0LjRjyDihJYg0KHQpC8xMjgtMjk4MyDQvtGCIDE4LjEx\n' +
        'LjIwMTYwLAYFKoUDZG8EIwwh0KHQmtCX0JggItCa0YDQuNC/0YLQvtCf0YDQviBD\n' +
        'U1AiMGAGA1UdHwRZMFcwVaBToFGGT2h0dHA6Ly90ZXN0Y2EyMDEyLmNyeXB0b3By\n' +
        'by5ydS9jZHAvYmI3ZWZjNDEyZDRhN2ViYjEyMGYwNGMyMDU1YjRjZWMzMmYwY2Y1\n' +
        'Yi5jcmwwawYIKwYBBQUHAQEEXzBdMFsGCCsGAQUFBzAChk9odHRwOi8vdGVzdGNh\n' +
        'MjAxMi5jcnlwdG9wcm8ucnUvYWlhL2JiN2VmYzQxMmQ0YTdlYmIxMjBmMDRjMjA1\n' +
        'NWI0Y2VjMzJmMGNmNWIuY3J0MCsGA1UdEAQkMCKADzIwMTcxMTAyMDY0MTQxWoEP\n' +
        'MjAxOTAyMDIwNjQxNDFaMAoGCCqFAwcBAQMCA0EAg2BJ3kkAanNi8l+36ZMQbU0G\n' +
        'psyTrybBIAeuDXxZPv5GOa4QgbqnyP589pQ4t+ETGUV8mxnSZ/hyq9hjb/bK5A==';


    public static certGOST256Json: string = '{\n' +
        '    version: 2,\n' +
        '    serialNumber: 1,\n' +
        '    signature: {\n' +
        '        name: "GOST R 34.10-256/GOST R 34.11-256",\n' +
        '        id: "id-tc26-signwithdigest-gost3410-12-256"\n' +
        '    },\n' +
        '    issuer: {\n' +
        '        countryName: "RU",\n' +
        '        stateOrProvinceName: "Санктъ-Петербургъ",\n' +
        '        organizationName: "Журнал \\"Современник\\"",\n' +
        '        organizationalUnitName: "Руководство",\n' +
        '        title: "Главный редактор",\n' +
        '        commonName: "Александр Сергеевич Пушкин"\n' +
        '    },\n' +
        '    notBefore: "2014-12-04T21:00:00.000Z",\n' +
        '    notAfter: "2034-12-04T21:00:00.000Z",\n' +
        '    subject: {\n' +
        '        countryName: "RU",\n' +
        '        stateOrProvinceName: "Санктъ-Петербургъ",\n' +
        '        organizationName: "Журнал \\"Современник\\"",\n' +
        ...
        '        },\n' +
        '        subjectPublicKey: [\n' +
        '            0x04, 0x40, 0x41, 0x40, 0x90, 0x36, 0x0e, 0x5e, 0x61, 0x82, 0x1c, 0xc6, 0xd6, 0x91, 0x11, 0x04,\n' +
        '            0x71, 0xbb, 0xf0, 0xe3, 0x5f, 0x31, 0xdf, 0x94, 0x79, 0x7e, 0xe9, 0x5d, 0x24, 0xeb, 0x67, 0xc4,\n' +
        '            0x38, 0xa1, 0xc5, 0xaa, 0x23, 0xc2, 0xff, 0x33, 0xba, 0x95, 0x27, 0x79, 0x36, 0x6e, 0x9a, 0x9f,\n' +
        '            0xc6, 0x76, 0xf2, 0x8c, 0x2b, 0x6a, 0xc2, 0x5d, 0x61, 0x7f, 0xc1, 0xf3, 0x10, 0x50, 0x34, 0x35,\n' +
        '            0x67, 0x1b\n' +
        '        ]\n' +
        '    },\n' +
        '    extensions: {\n' +
        ...
        '            0x9d, 0x61, 0x59, 0xca, 0xa8, 0x15, 0x9d, 0x69, 0xa8, 0xd8, 0x6e, 0xcb, 0x4d, 0xde, 0xd3, 0xb1,\n' +
        '            0xdc, 0x8b, 0xd0, 0xb3\n' +
        '        ],\n' +
        ...
        '    },\n' +
        '    signatureValue: [\n' +
        '        0x04, 0xbf, 0x9c, 0xc9, 0x1c, 0xa9, 0xb4, 0x9a, 0x10, 0x0d, 0x01, 0xff, 0x80, 0xb5, 0x0d, 0x1c,\n' +
        '        0xef, 0x75, 0x40, 0xbe, 0xd9, 0x5d, 0xc6, 0x11, 0xf6, 0xad, 0x40, 0x71, 0x50, 0x1b, 0x79, 0x04,\n' +
        '        0x37, 0x36, 0x39, 0x90, 0x69, 0x8e, 0xcc, 0x3b, 0xb8, 0x59, 0xca, 0xd1, 0x6e, 0x84, 0x5d, 0x19,\n' +
    ...
    public static pkeyRsaJson = '{\n' +
        ...
        '    ]\n' +
        '}';
    static cryptoProName: string = 'MCkWJ2xlLWQzYmI4MDIzLTliNmEtNGRjMC05ZGI5LTdmNmQwNTUxNmY5OA==';
    static cryptoProNameJson: string = '{\n' + '    containerName: "le-d3bb8023-9b6a-4dc0-9db9-7f6d05516f98"\n' + '}';
    ...
    static cryptoProConteiner = {
        header: 'MIICnjCCApSgCgYIKoUDAgIlAgEDAgZAMCsDAgKkoCUGBiqFAwICYjAbBgcqhQMCAiQABgcqhQMCAh4BBgcqhQMCAh8BhYIC\n' +
            'IjCCAh4wggHNoAMCAQICBEyRh2gwCAYGKoUDAgIDMB0xCzAJBgNVBAYTAlJVMQ4wDAYDVQQDEwVBbGlhczAeFw0xOTA5MDIy\n' +
            'MTAwMDBaFw0zOTA5MDIyMTAwMDBaMB0xCzAJBgNVBAYTAlJVMQ4wDAYDVQQDEwVBbGlhczBjMBwGBiqFAwICEzASBgcqhQMC\n' +
            'AiQABgcqhQMCAh4BA0MABEDjy4C7edc0SHYkODMXNlX9ZWpDUz124dx2Q6v6New0tzi0ibm6Iz5bW+kKWAkhO2VEEELXk2Z+\n' +
            'BpZplR9yRDGGo4HyMIHvMA4GA1UdDwEB/wQEAwIB/jBjBgNVHSUEXDBaBggrBgEFBQcDAQYIKwYBBQUHAwIGCCsGAQUFBwMD\n' +
            'BggrBgEFBQcDBAYIKwYBBQUHAwUGCCsGAQUFBwMGBggrBgEFBQcDBwYIKwYBBQUHAwgGCCsGAQUFBwMJMA8GA1UdEwEB/wQF\n' +
            'MAMBAf8wHQYDVR0OBBYEFMMMsx+fwBtYcpcvsmUXkQYbLAGKMEgGA1UdIwRBMD+AFMMMsx+fwBtYcpcvsmUXkQYbLAGKoSGk\n' +
            'HzAdMQswCQYDVQQGEwJSVTEOMAwGA1UEAxMFQWxpYXOCBEyRh2gwCAYGKoUDAgIDA0EAKXSpMowAPQqqnsckFgidECaGZVzA\n' +
            'MSsLadODDlz5jWISMBqO2l8UdLDQMawmdE6PBOIsMPG+w/kP5XWjy68NTIoI48uAu3nXNEisJTAjBggqhQMCAiUDCgQXMBWB\n' +
            'EzIwMzkwOTAyMjEwODQ2Ljc2OFoEBBcydtk=',
        name: 'MAcWBUFsaWFz',
        primary: 'MCIEIPdNrKa+Ytkvi3HuKo3LOBUUHkQOU5rvCaSkTK2kfk8I',
        primary2: 'MCIEIE3I0tUWMHINPQKLrXSPhHI7O9V/X7fluPZ+Ie4eL6WD',
        masks: 'MDYEIB+l+vhuOhfDw3C1d/LQJVF2ndjWFRljzhAJgEfdasV6BAyKRVd9Z8LRu2lL+FgEBB7IIwQ=',
        masks2: 'MDYEIHha1X7XLNpJFPYgwe/BrNS9hxYE613Cq7WAs1Wx6UXfBAwzaLXcC5MMxnCJMJ8EBLg9P/A='
    };
}
