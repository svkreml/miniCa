export class GostSecurity {
    ...
    names = {
        ...
        // symmetric key algorithm oids
        '2.16.840.1.101.3.4': 'nistthis.algorithms',
        ...
        '2.5.4.52': 'supportedthis.algorithms',
    ...
    parameters = {
        ...
        // Curve attributes additional this.algorithms
    ...
    providers = {
        'CP-94': {
            ...
            signature: this.algorithms['id-GostR3411-94-with-GostR3410-94'],
            ...
            digest: this.algorithms['id-GostR3411-94'],
            wrapping: {id: 'id-Gost28147-89-CryptoPro-KeyWrap', name: 'GOST 28147-89-CPKW', sBox: 'E-A'},
            hmac: this.algorithms['id-HMACGostR3411-94'],
            agreement: this.algorithms['id-GostR3410-94-CryptoPro-ESDH'],
        ...
        'CP-01': {
            ...
            signature: this.algorithms['id-GostR3411-94-with-GostR3410-2001'],
            ...
            wrapping: {id: 'id-Gost28147-89-CryptoPro-KeyWrap', name: 'GOST 28147-89-CPKW', sBox: 'E-A'},
            hmac: this.algorithms['id-HMACGostR3411-94'],
            agreement: this.algorithms['id-GostR3410-2001-CryptoPro-ESDH'],
        ...
        'TC-256': {
            ...
            signature: this.algorithms['id-tc26-signwithdigest-gost3410-12-256'],
            ...
            digest: this.algorithms['id-tc26-gost3411-12-256'],
            wrapping: {id: 'id-Gost28147-89-CryptoPro-KeyWrap', name: 'GOST 28147-89-CPKW', sBox: 'E-A'},
            hmac: this.algorithms['id-tc26-hmac-gost-3411-12-256'],
            agreement: this.algorithms['id-tc26-agreement-gost-3410-12-256'],
            encryption: {id: 'id-Gost28147-89', name: 'GOST 28147-89-CFB-CPKM', sBox: 'E-A'},
        ...
        'TC-512': {
            ...
            signature: this.algorithms['id-tc26-signwithdigest-gost3410-12-512'],
            ...
            digest: this.algorithms['id-tc26-gost3411-12-512'],
            wrapping: {id: 'id-Gost28147-89-CryptoPro-KeyWrap', name: 'GOST 28147-89-CPKW', sBox: 'E-A'},
            hmac: this.algorithms['id-tc26-hmac-gost-3411-12-512'],
            agreement: this.algorithms['id-tc26-agreement-gost-3410-12-512'],
            encryption: {id: 'id-Gost28147-89', name: 'GOST 28147-89-CFB-CPKM', sBox: 'E-A'},
            derivation: {id: 'PBKDF2', name: 'GOST R 34.11-256-PBKDF2', iterations: 2000}
        },
        'SC-94': {
            title: 'Signal-COM GOST Cryptographic Provider',
            signature: this.algorithms['id-sc-gostR3411-94-with-gostR3410-94'],
            ...
            digest: this.algorithms['id-sc-gostR3411-94'],
            encryption: {id: 'id-sc-gost28147-gfb', name: 'GOST 28147-89-CFB/SC'},
            hmac: this.algorithms['id-sc-hmacWithGostR3411'],
            wrapping: ['id-sc-cmsGostWrap'],
            agreement: this.algorithms['id-sc-r3410-ESDH-r3411kdf'],
        ...
        'SC-01': {
            ...
            signature: this.algorithms['id-sc-gostR3411-94-with-gostR3410-2001'],
            ...
            encryption: {id: 'id-sc-gost28147-gfb', name: 'GOST 28147-89-CFB/SC'},
            hmac: this.algorithms['id-sc-hmacWithGostR3411'],
            wrapping: this.algorithms['id-sc-cmsGostWrap'],
            agreement: this.algorithms['id-sc-r3410-ESDH-r3411kdf'],
            derivation: {id: 'PBKDF2', name: 'GOST R 34.11-94-PBKDF2/SC', iterations: 2048},
            pbes: {
                id: 'id-sc-pbeWithGost3411AndGost28147CFB',
        ...
        'RSA-2048': {
            ...
            signature: this.algorithms.sha256withRSAEncryption,
            publicKey: {
                id: 'rsaEncryption', name: 'RSASSA-PKCS1-v1_5', modulusLength: 2048,
                publicExponent: new Uint8Array([0x01, 0x00, 0x01]), hash: this.algorithms.sha256
            },
            privateKey: {
                id: 'rsaEncryption', name: 'RSASSA-PKCS1-v1_5', modulusLength: 2048,
                publicExponent: new Uint8Array([0x01, 0x00, 0x01]), hash: this.algorithms.sha256
            },
            digest: this.algorithms.sha256,
            encryption: this.algorithms['aes256-CFB'],
            hmac: this.algorithms.hmacWithSHA256
        },
        'ECDSA-256': {
            title: 'Microsoft Base DSS and Diffie-Hellman Cryptographic Provider',
            signature: this.algorithms['ecdsa-with-SHA256'],
            publicKey: {id: 'ecdsa', name: 'ECDSA', namedCurve: 'P-256'},
            privateKey: {id: 'ecdsa', name: 'ECDSA', namedCurve: 'P-256'},
            digest: this.algorithms.sha256,
            encryption: this.algorithms['aes256-CFB'],
            hmac: this.algorithms.hmacWithSHA256,
            agreement: this.algorithms.ecDH
        }
    };
    ...
    constructor() {
        ...
        for (const id in this.names) {
            this.identifiers[this.names[id]] = id;
        }
        // tslint:disable-next-line:forin
        for (const id in this.algorithms) {
            let algorithm = this.algorithms[id];
        ...
        ['CP-94', 'CP-01', 'TC-256', 'TC-512', 'SC-94', 'SC-01'].forEach((name) => {
            const provider = this.providers[name];
            provider.hmac = this.expand([provider.hmac, {hash: provider.digest}]);
            provider.derivation = this.expand([provider.derivation, {hash: provider.digest, hmac: provider.hmac}]);
            ...
            provider.agreement = this.expand([provider.agreement, {wrapping: provider.wrapping}]);
        });


        // RSA & ECDA providers extension
        ['RSA-2048', 'ECDSA-256'].forEach((name) => {
            const provider = this.providers[name];
